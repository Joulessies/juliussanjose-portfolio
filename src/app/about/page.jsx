...
const contactLinks = [
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/joulessies',
    subtext: 'Visit my GitHub',
    external: true,
  },
];
    ...
    <div className="about-page">
      ...
      <main className="about-page__content">
        <div className="about-grid">
          <motion.section
            className="about-panel about-panel--timeline"
            custom={0}
          ...
          <motion.section
            className="about-panel about-panel--profile"
            custom={1}
            variants={panelVariants}
            initial="hidden"
            animate="visible"
          ...
          <motion.section
            className="about-panel about-panel--skills"
            custom={2}
            variants={panelVariants}
            initial="hidden"
            animate="visible"
          ...
          <motion.section
            className="about-panel about-panel--values"
            custom={3}
            variants={panelVariants}
            initial="hidden"
            animate="visible"
          ...
          <motion.section
            className="about-panel about-panel--workflow"
            custom={4}
            variants={panelVariants}
            initial="hidden"
            animate="visible"
